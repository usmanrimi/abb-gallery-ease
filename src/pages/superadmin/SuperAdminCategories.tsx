                ...
                {loading ? (
                    ...
                    <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
                        {filteredCategories.map((category) => (
                            <Card key={category.id} className={`overflow-hidden group transition-all duration-300 hover:shadow-xl hover:shadow-primary/10 border-primary/20 bg-background/50 backdrop-blur-sm ${category.is_coming_soon ? "border-dashed opacity-90" : ""}`}>
